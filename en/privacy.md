...
- **Imported transaction data:** asset or ticker names, transaction type, transaction date, quantity, price, currency, and brokerage or bank document details extracted from files or connected email sources if you choose to use import features.
- **Gmail data:** email metadata, email body text, and PDF attachment content if you explicitly connect Gmail for transaction import.
...
- Provide portfolio tracking and profit/loss calculations.
...
**Gmail connection is optional.** You can use Walletify and enter transactions manually without connecting Gmail.
...
Walletify uses Gmail access only to search for supported investment and brokerage emails, read relevant message content and PDF attachments, and extract transaction details for your personal portfolio tracking.

Walletify does not sell Gmail data, use Gmail data for advertising or ad targeting, use Gmail data to build profiles, or use Gmail data to train AI or machine learning models.

You can disconnect Gmail in the app or revoke access from your Google Account security settings at [myaccount.google.com/permissions](https://myaccount.google.com/permissions).

Walletify's use and transfer of information received from Google APIs follows the [Google API Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy), including the Limited Use requirements.
...
| Firebase Firestore | Cloud sync and app data storage |
...
| Gmail API | Optional investment email import |
| Google Mobile Ads / AdMob | Advertising for free users |
| RevenueCat | Subscription and purchase entitlement management |
| Google Play Billing / App Store | In-app purchases and subscriptions |
...
You can request deletion of your Walletify account and associated app data in the app:
