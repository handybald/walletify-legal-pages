...
Walletify is a portfolio tracking app. It helps users record assets, import transactions, track prices, and calculate portfolio values and profit/loss.
...
Walletify does not guarantee that prices, calculations, imports, or profit/loss values are accurate or suitable for trading, tax reporting, or official records.
...
Subscription billing, cancellation, refunds, and renewal terms are managed by the platform where the purchase was made, such as Google Play or the App Store.
